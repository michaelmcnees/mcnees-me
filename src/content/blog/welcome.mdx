...
So I rebuilt it. From scratch. And then I kept going — redesigning the whole thing into something that actually feels like it belongs to me.

## Why now?

I've been doing more writing lately — notes to my team, internal docs, the occasional long Slack message that probably should have been a blog post. I kept wanting a place to put those thoughts where they could live longer than a thread.
...
- **Astro** for the framework — built for content sites, ships zero JavaScript by default
...
- **Homelabbing and smart home** — the intersection of tinkering and living with the things you build
